...
**5. Level 1 Tileset (screenshot)**

![Level 1 Tileset](Assets/Custom%20Tileset/Tilesets/Level_1/Level_1_256x256.png)

**6. Enemy texture (screenshot)**

![Enemy Texture](Assets/Enemy%20Knight/ColorSwap/swap_texture.png)
