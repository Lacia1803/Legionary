...
Xem demo gameplay dưới đây (file video nằm ở thư mục gốc dự án):

<video src="DemoGame.mp4" controls width="640" poster="2dmain.png">
   Trình duyệt của bạn không hỗ trợ thẻ video. Bạn có thể tải video về tại liên kết: [Tải demo](DemoGame.mp4).
</video>
